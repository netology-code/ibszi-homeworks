...
3. Загружен журнал SIEM. **Журнал доступен в личном кабинете в материалах к этому занятию (этой лекции)** -"Инструменты и дополнительные материалы, которые пригодятся для выполнения домашнего задания".
