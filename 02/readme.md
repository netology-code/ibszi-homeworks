...
Secret Net Studio – система защиты информации. Это программное обеспечение часто используют в государственных и коммерческих организациях. При трудоустройстве на должность специалиста по ИБ работодатели оценивают опыт в настройке СЗИ. После выполнения задания вы сможете добавить в своё резюме, что имеете практический опыт в установке и настройке Secret Net Studio.
...
3. Создайте на диске C папку «КТ». В этой папаке создайте документ Word с содержанием «Коммерческая тайна».
4. Сделайте настройку полномочного управления доступом, чтобы пользователь `petrov` не мог открыть конфиденциальный документ с коммерческой тайной.
...
- выполненить все этапы, предусмотренныме заданиями 1-4,
